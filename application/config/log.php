 ...
 *
 * If you decide to store the logs inside a database this is the sql for the "logs" table
 *
 *
SET NAMES utf8;
...
$config['store_in'] = 'logs';
$config['session_user_id'] = ''; // You can tell the library to take the user id from a session variable
$config['table_name'] = 'logs'; // If you prefer to name the table other than "logs" you can set it here...
