                            ...
                            <div class="block-content block-content-narrow">
                                <form id="addform" class="js-validation-bootstrap form-horizontal" action="<?php echo base_url('back/Members/member_edit')?>" method="post" novalidate="novalidate" autocomplete="off">
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-2 control-label">版本編號</label>
                                        <div class="col-md-7">
                                            <input type="text" class="form-control" v-model="model.version_number" name="version_number" />
                                        </div>
                                    </div>
                                    <div class="form-group" >
                                        ...
                                        <div class="col-md-8">
                                            ...
                                            <div class="form-control-static">{{model.create_date}}</div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="col-md-10 col-md-offset-2 text-right">
                                            <button class="btn btn-lg btn-inverse" type="button" @click="model_edit">更新</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
...
<script>
    ...
    var vue_obj = new Vue({
        ...
        data: {
            model: {},
            xq:[""],
            api_model_edit:"<?php echo base_url('back/Versions/versions_edit')?>",
        },
        mounted: function () {
