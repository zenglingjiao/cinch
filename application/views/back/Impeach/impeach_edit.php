                        ...
                        <div class="block">
                            ...
                            <div class="block-content block-content-narrow">
                                <form id="addform" class="js-validation-bootstrap form-horizontal" action="<?php echo base_url('back/Members/member_edit')?>" method="post" novalidate="novalidate" autocomplete="off">
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-2 control-label">檢舉類型</label>
                                        <div class="col-md-4">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-7">
                                            <label class="" >{{model.content}}</label>
                                        </div>
                                    </div>
<!--                                    <div class="form-group">-->
...
<!--                                    </div>-->
                                    <div class="form-group picss" >
                                        ...
                                        <div class="col-md-7">
                                            <div class="sort_img_list">
                                                ...
                                                <div class="sort_img">
                                                    <div class="form-group-z" v-for="(x,x_index) in model.imgs">
                                                        <div id="preimg">
                                                            <div class='imgContainer'>
                                                                <img style="width: 200px;height: 200px" title='分類圖' class="src_list" :src="x"  onerror=this.onerror=null;this.src="assets/images/no.jpg" alt='图片'/></a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-2 control-label">管理員回復</label>
                                        <div class="col-md-7">
                                            <textarea  class="form-control" id="contact1-msg" v-model="model.reply" name="reply" rows="7" placeholder=""></textarea>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-2 control-label">狀態</label>
                                        <div class="col-md-7">
                                            <label class=" control-label">{{model.reply?'已處理':'未處理'}}</label>
