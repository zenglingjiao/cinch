                        ...
                        <div class="block">
                            ...
                            <div class="block-content block-content-narrow">
                                <form id="addform" class="js-validation-bootstrap form-horizontal" action="<?php echo base_url('back/Members/member_edit')?>" method="post" novalidate="novalidate" autocomplete="off">
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-2 control-label">時間</label>
                                        <div class="col-md-7">
...
<script>
    var validator;
    $(function () {
        calenders("#added_time", false, true);
    ...
    var vue_obj = new Vue({
        ...
        methods: {
            ...
            model_edit:function () {
                ...
                var fd = new FormData();
                console.log(document.getElementById('added_time').value);
                if(this.update_file&&this.update_file.file){
                    fd.append("up_file", this.update_file.file[0]);
                }
                fd.append("added_time",document.getElementById('added_time').value);
