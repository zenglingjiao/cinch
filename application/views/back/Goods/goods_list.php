                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="class_type" id="class_type" class="form-control">
                                            ...
                                            <?php if(isset($main_class_list) ){ foreach ($main_class_list as $main_class){?>
                                                <optgroup label="<?php echo $main_class->name?>">
                                                    <?php if(isset($small_class_list)){ foreach ($small_class_list as $small_class){ if($main_class->id==$small_class->parent_id){ ?>
                                                        <option value="<?php echo $small_class->id?>"><?php echo $small_class->name?></option>
                                                    <?php } }}?>
                                                </optgroup>
                                            <?php }}?>
                                        </select>
