                            ...
                            <div class="block-content block-content-narrow">
                                <form id="addform" class="js-validation-bootstrap form-horizontal" action="<?php echo base_url('back/Members/member_edit')?>" method="post" novalidate="novalidate" autocomplete="off">
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-2 control-label">物品主分類</label>
                                        <div class="col-md-7">
                                            <select class="form-control" name="class_type" id="class_type" placeholder="請選擇主分類" v-model="model.parent_id">
                                                <option value="">請選擇主分類</option>
                                                <option v-for="main_type in main_type_list" :value="main_type.id">{{main_type.name}}</option>
                                            </select>

                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-2 control-label">物品分類名稱</label>
                                        <div class="col-md-7">
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-2 control-label">小分類圖</label>
                                        <div class="col-md-3">
                                            <div class="btn btn_en btn-success" onclick="document.getElementById('upload').click();"><i class="fa fa-image"></i>瀏覽
                                                ...
                                                <input type="text" :value="model.pic" name="has_upimg" id="has_upimg" style="opacity: 0;position: absolute;" />
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="sort_img_list">
                                                <div class="sort_img">
                                                    <div class="form-group-t">
                                                        <button type="button" class="btn btn-warning" @click="update_file={};model.pic='';">刪除</button>
                                                    </div>
    ...
    var vue_obj = new Vue({
        ...
        mounted: function () {
            ...
            if (json_model) {
                ...
                if(this.model.pic){
                    this.update_file = {name: '設備圖', file: null, src: this.model.pic, type: 'img'};
                }
            }

            var json_main_type_list = JSON.parse(decodeURIComponent('<?php echo urlencode(json_encode((isset($main_type_list) ? $main_type_list : null)))?>'.replace(/\+/g," ")));
            if(json_main_type_list){
                this.main_type_list = json_main_type_list;
            }
        },
        methods: {
