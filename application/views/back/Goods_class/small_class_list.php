                        ...
                        <div class="smart-widget-header">
                            <form class="form-inline no-margin herd-from-alert" id="form_search">
                                <div class="cleom">
                                    ...
                                    <div class="form-group">
                                        <label class="control-label" for="">主分類：</label>
                                        <select name="class_type" id="class_type" class="form-control">
                                            <option value=""></option>
                                            <?php if(isset($main_class_list)){ foreach ($main_class_list as $main_class){?>
                                                <option value="<?php echo $main_class->id?>"><?php echo $main_class->name?></option>
                                            <?php }}?>
                                        </select>
                                    </div>
                                    <div class="form-group">
            ...
            <div class="message-table table-responsive smart-widget push-10" id="btn_box">
                <div class="smart-widget-header">
                    <div class="form-inline no-margin">
                        <div style="">
                            <div class="form-group">
                                <button type="button" class="btn btn-danger" onclick ="Ajax_Post_Select_msg('刪除選定項？ 刪除後無法還原！', '<?php echo base_url('back/Goods/main_class_delete')?>', 'table-javascript', '至少選擇一條')">選擇刪除</button>
                            </div>
                        </div>
                    </div>
                </div>
