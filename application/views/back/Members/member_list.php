    ...
    <main id="main-container">
        ...
        <div class="content bg-gray-lighter">
            <div class="row items-push">
                ...
                <div class="col-sm-5 text-right hidden-xs">
                    <a href="<?php echo base_url('back/Members/member_edit')?>" class="btn btn-primary" title="新增">新增</a>
                </div>
            </div>
        </div>
        <!-- END Page 中間標題頭部 -->
        ...
        <div class="content">
                        ...
                        <div class="smart-widget-header">
                            <form class="form-inline no-margin herd-from-alert" id="form_search">
                                ...
                                <div class="cleom">
                                    ...
                                    <button type="button" class="btn btn-warning btn-clean" onclick="cleanForm()">清除</button> <button type="button" class="btn btn-success btn-query" onclick="$('#search').val('1');$('#table-javascript').bootstrapTable('refreshOptions',{pageNumber:1});">查詢</button>
                                    <div class="clearfix">
            ...
            <div class="message-table table-responsive smart-widget">
                ...
                <!--这是表格 -->
                <table class="table" id="table-javascript">
            ...
            <div class="message-table table-responsive smart-widget push-10" id="btn_box">
                <div class="smart-widget-header">
                    <div class="form-inline no-margin">
                        <div style="">
                            <div class="form-group">
                                <button type="button" class="btn btn-danger" onclick ="Ajax_Post_Select_msg('刪除選定項？ 刪除後無法還原！', '<?php echo base_url('back/Members/member_delete')?>', 'table-javascript', '至少選擇一條')">選擇刪除</button>
                            </div>
                        </div>
                    </div>
                </div>
...
<script>
    ...
    $('#table-javascript').bootstrapTable({
        method: 'post',
        url: '<?php echo base_url('back/Members/member_list')?>',
        striped: true,
        pagination: true,
        pageSize: 10,
        ...
        onClickRow: function (row, $element, field) {
            ...
            //    window.location.href = "<?php //echo base_url('back/Members/member_edit/')?>//" + row.id;
            //}
        },
        //表格頁面數據渲染數據後執行的方法
    ...
    function operateFormatter(value, row, index) {
        return [
            '<a class="btn btn-primary" href="back/Members/member_edit/' + row.id + '" title="編輯">編輯</a>'
        ].join('');
