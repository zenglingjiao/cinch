                                ...
                                <form id="addform" class="js-validation-bootstrap form-horizontal" action="<?php echo base_url('back/Members/member_edit')?>" method="post" novalidate="novalidate" autocomplete="off">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-7">
                                            ...
                                            <span style="color: red;" v-if="size2">尺寸限制：157＊197</span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-2 control-label">網址</label>
                                        <div class="col-md-7">
                                            <input type="text" class="form-control" v-model="model.url" name="url" />
                                        </div>
                                    </div>
                                    <div class="form-group">
