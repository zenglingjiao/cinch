            ...
            <div class="row items-push">
                ...
                <div class="col-sm-5 text-right hidden-xs">
                    <ol class="breadcrumb push-10-t">
                        ...
                        <li><a class="link-effect" href="<?php echo base_url('back/Store/activitie_list')?>">活動列表</a></li>
                            ...
                            <div class="block-content block-content-narrow">
                                <form id="addform" class="js-validation-bootstrap form-horizontal" action="" method="post" novalidate="novalidate" autocomplete="off">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-3">
                                            <select class="form-control selectpicker" name="preferential_id" id="preferential_id" v-model="model.preferential_id" data-live-search="true">
...
<!--                                    <div class="form-group" v-show="model.mode==4">-->
<!--                                        <label class="col-md-2 control-label">會員限制</label>-->
<!--                                        <div class="col-md-3">-->
<!--                                            <select class="form-control selectpicker" name="limits" id="limits" v-model="model.limits" data-live-search="true">-->
...
<script>
    ...
    function SendAjax() {
        ...
        $.ajax({
            type: 'post',
            url: '<?php echo base_url('back/Store/activitie_edit') ?>',
            data: fd,
            cache: false,
