                        ...
                        <div class="block">
                            ...
                            <div class="block-content block-content-narrow">
                                <form id="addform" class="js-validation-bootstrap form-horizontal" action="<?php echo base_url('back/Members/member_edit')?>" method="post" novalidate="novalidate" autocomplete="off">
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-2 control-label">宣言</label>
                                        <div class="col-md-7">
                                            <input type="text" class="form-control" v-model="model.manifesto" name="manifesto" />
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-7">
                                            ...
                                            <span style="color: red;" v-if="size2">尺寸限制：79＊75</span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-3">
                                            <input type="text" class="form-control" v-model="model.crew1_name" name="crew1_name" />
                                        </div>
                                        <label class="col-md-2 control-label">會員編號</label>
                                        <div class="col-md-3">
                                            <input type="text" class="form-control" v-model="model.crew1_no" name="crew1_no" />
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <label class="col-md-2 control-label">會員編號</label>
                                        <div class="col-md-3">
                                            <input type="text" class="form-control" v-model="model.crew3_no" name="crew3_no" />
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-2 control-label">組員4姓名</label>
                                        <div class="col-md-3">
                                            <input type="text" class="form-control" v-model="model.crew4_name" name="crew4_name" />
                                        </div>
                                        <label class="col-md-2 control-label">會員編號</label>
                                        <div class="col-md-3">
