...
<!-- END Icons -->
<!-- 样式部分 -->
<!-- Page JS Plugins CSS 滚动插件 -->
<link rel="stylesheet" href="assets/plugins/slick/slick.min.css">
<link rel="stylesheet" href="assets/plugins/slick/slick-theme.min.css">
<!-- OneUI CSS framework -->
...
<link href="assets/css/jackedup.css" rel="stylesheet">
<link href="assets/plugins/bootstrap-select/bootstrap-select.css" rel="stylesheet">
<link href="assets/plugins/simditor/simditor.css" rel="stylesheet">
<!-- END 样式部分 -->
<style>
    [v-cloak] {
        display: none;
