                                    ...
                                    <div class="form-group" v-if="model.id&&model.id>0">
                                        ...
                                        <div class="col-md-7">
                                            <label class="css-input css-radio css-radio-warning push-10-r">
                                                <input type="radio" value="0" v-model="model.state" name="state"><span></span> 待加壓
                                            </label>
                                            <label class="css-input css-radio css-radio-warning push-10-r">
                                                <input type="radio" value="1" v-model="model.state" name="state"><span></span> 已濃縮
                                            </label>
                                            <label class="css-input css-radio css-radio-warning push-10-r">
                                                <input type="radio" value="2" v-model="model.state" name="state"><span></span> 已完成
                                            </label>
                                        </div>
                                    </div>
                                    <div class="form-group" v-if="model.id&&model.id>0">
