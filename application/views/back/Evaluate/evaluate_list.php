...
<!--                </div>-->
                            ...
                            <form class="form-inline no-margin herd-from-alert" id="form_search">
                                <div class="cleom">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text" id="name" name="name" placeholder="搜尋訂單編號、會員帳號、商品名稱">
                                    </div>
                                    <div class="form-group">
    ...
    <!-- END Main 中間容器 -->
    <!-- 模态框（Modal） -->
    <div  class="modal fade" id="show_opt_modal" tabindex="-1" role="dialog" aria-labelledby="show_opt_Label" aria-hidden="true">
        <div class="modal-dialog sb-cumtor-50" style="overflow-y:auto;height:90%;">
            <div class="modal-content" style="">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                    <h4 class="modal-title" id="show_opt_Label">訂單記錄</h4>
                </div>
                <div class="modal-body" id="mybody">
                    <div class="form-group" style="text-align: left;font-size: 20px;">
                        <span class="col-md-4" style="text-align: right">訂單編號：</span>
                        <span class="col-md-6 zhi">1111111</span>
                        <br>
                    </div>
                    <div class="form-group" style="text-align: left;font-size: 20px;">
                        <span class="col-md-4" style="text-align: right">會員帳號：</span>
                        <span class="col-md-6 zhi">1111111</span>
                        <br>
                    </div>
                    <div class="form-group" style="text-align: left;font-size: 20px;">
                        <span class="col-md-4" style="text-align: right">商品名稱：</span>
                        <span class="col-md-6 zhi">1111111</span>
                        <br>
                    </div>
                    <div class="form-group" style="text-align: left;font-size: 20px;">
                        <span class="col-md-4" style="text-align: right">贈物方帳號：</span>
                        <span class="col-md-6 zhi">1111111</span>
                        <br>
                    </div>
                    <div class="form-group" style="text-align: left;font-size: 20px;">
                        <span class="col-md-4" style="text-align: right">評價：</span>
                        <span class="col-md-6 zhi">1111111</span>
                        <br>
                    </div>
                    <div class="form-group" style="text-align: left;font-size: 20px;">
                        <span class="col-md-4" style="text-align: right">建立時間：</span>
                        <span class="col-md-6 zhi">1111111</span>
                        <br>
                    </div>
                </div>
...
<script>
    ...
    function operateFormatter(value, row, index) {
        return [
            "<button class='btn btn-info btn-clean'  onClick='check("+ JSON.stringify(row) +");'>查看</button >"
        ].join('');
    ...
    function check(value) {
        ...
        //             '<span style="font-size: 20px">店家：</span>' +
        //             '<div class="modal-title" >'+a[i]['content']+'</div>'+a[i]['create_data']+'</div><br>';
        //     }else {
        ...
        //     '<div class="col-md-8">' +
        //     '<div class="form-control-static">'+a.order_no+'</div>' +
        //     '</div></div>';

        // $('#mybody').html(str);
        $('.zhi').eq(0).html(value.order_no);
        $('.zhi').eq(1).html(value.member_account);
        $('.zhi').eq(2).html(value.goods_name);
        $('.zhi').eq(3).html(value.donor_account);
        $('.zhi').eq(4).html(value.matter);
        $('.zhi').eq(5).html(value.created_at);
        $('#show_opt_modal').modal('show');
    }
