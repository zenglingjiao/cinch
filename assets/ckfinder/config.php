...
$config['authentication'] = function () {
    if (isset($_SESSION["upload_image_file_manager"]) && $_SESSION["upload_image_file_manager"] == true) {
        return true;
    } else {
        return false;
    }
...
$config['licenseName'] = 'www.huiduoduo.com:81';
$config['licenseKey']  = '*6?8-*1**-D**1-*D**-*1**-E*Q*-2**J';
...
//$baseUrl = '/updata/userfiles/';
$config['backends'][] = array(
    'name'         => 'default',
    'adapter'      => 'local',
    'baseUrl'      => '/updata/ckfinder/userfiles/',
